...
| 7. Console 0.1 | [console.py](https://github.com/codeshoel/AirBnB_clone/blob/dev/console.py) | Update the console with methods allowing the user to create, destroy, show, and update stored data |
